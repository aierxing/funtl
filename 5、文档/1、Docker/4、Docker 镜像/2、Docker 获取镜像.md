# [#](https://funtl.com/zh/docs-docker/Docker-获取镜像.html#docker-获取镜像)Docker 获取镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-获取镜像.html#运行)运行
...
← [使用 Docker 镜像](https://funtl.com/zh/docs-docker/使用-Docker-镜像.html)[Docker 列出镜像 ](https://funtl.com/zh/docs-docker/Docker-列出镜像.html)→