# [#](https://funtl.com/zh/docs-docker/Docker-其它制作镜像的方式.html#其它制作镜像的方式)其它制作镜像的方式

除了标准的使用 `Dockerfile` 生成镜像的方法外，由于各种特殊需求和历史原因，还提供了一些其它方法用以生成镜像。

## [#](https://funtl.com/zh/docs-docker/Docker-其它制作镜像的方式.html#从-rootfs-压缩包导入)从 rootfs 压缩包导入
...
## [#](https://funtl.com/zh/docs-docker/Docker-其它制作镜像的方式.html#docker-save-和-docker-load)`docker save` 和 `docker load`
...
### [#](https://funtl.com/zh/docs-docker/Docker-其它制作镜像的方式.html#保存镜像)保存镜像
...
← [Dockerfile 多阶段构建](https://funtl.com/zh/docs-docker/Docker-Dockerfile-多阶段构建.html)[镜像的实现原理 ](https://funtl.com/zh/docs-docker/Docker-镜像的实现原理.html)→