# [#](https://funtl.com/zh/docs-docker/Docker-列出镜像.html#docker-列出镜像)Docker 列出镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-列出镜像.html#镜像体积)镜像体积
...
## [#](https://funtl.com/zh/docs-docker/Docker-列出镜像.html#虚悬镜像)虚悬镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-列出镜像.html#中间层镜像)中间层镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-列出镜像.html#列出部分镜像)列出部分镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-列出镜像.html#以特定格式显示)以特定格式显示
...
← [Docker 获取镜像](https://funtl.com/zh/docs-docker/Docker-获取镜像.html)[Docker 删除本地镜像 ](https://funtl.com/zh/docs-docker/Docker-删除本地镜像.html)→