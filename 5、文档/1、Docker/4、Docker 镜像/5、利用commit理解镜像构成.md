# [#](https://funtl.com/zh/docs-docker/Docker-利用-commit-理解镜像构成.html#利用-commit-理解镜像构成)利用 commit 理解镜像构成
...
![img](https://funtl.com/assets/images-mac-example-nginx.png)
...
![img](https://funtl.com/assets/images-create-nginx-docker.png)
...
## [#](https://funtl.com/zh/docs-docker/Docker-利用-commit-理解镜像构成.html#慎用-docker-commit)慎用 `docker commit`
...
← [Docker 删除本地镜像](https://funtl.com/zh/docs-docker/Docker-删除本地镜像.html)[使用 Dockerfile 定制镜像 ](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html)→