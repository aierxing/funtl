# [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#使用-dockerfile-定制镜像)使用 Dockerfile 定制镜像

## [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#dockerfile-定制镜像)Dockerfile 定制镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#from-指定基础镜像)FROM 指定基础镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#run-执行命令)RUN 执行命令
...
## [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#构建镜像)构建镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#镜像构建上下文（context）)镜像构建上下文（Context）
...
## [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#其它-docker-build-的用法)其它 `docker build` 的用法

### [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#直接用-git-repo-进行构建)直接用 Git repo 进行构建
...
### [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#用给定的-tar-压缩包构建)用给定的 tar 压缩包构建
...
### [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#从标准输入中读取-dockerfile-进行构建)从标准输入中读取 Dockerfile 进行构建
...
### [#](https://funtl.com/zh/docs-docker/Docker-使用-Dockerfile-定制镜像.html#从标准输入中读取上下文压缩包进行构建)从标准输入中读取上下文压缩包进行构建
...
← [利用 commit 理解镜像构成](https://funtl.com/zh/docs-docker/Docker-利用-commit-理解镜像构成.html)[Dockerfile 指令详解 ](https://funtl.com/zh/docs-docker/Docker-Dockerfile-指令详解.html)→