# [#](https://funtl.com/zh/docs-docker/Docker-删除本地镜像.html#docker-删除本地镜像)Docker 删除本地镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-删除本地镜像.html#用-id、镜像名、摘要删除镜像)用 ID、镜像名、摘要删除镜像
...
## [#](https://funtl.com/zh/docs-docker/Docker-删除本地镜像.html#untagged-和-deleted)Untagged 和 Deleted
...
## [#](https://funtl.com/zh/docs-docker/Docker-删除本地镜像.html#用-docker-image-ls-命令来配合)用 docker image ls 命令来配合
...
## [#](https://funtl.com/zh/docs-docker/Docker-删除本地镜像.html#centos-rhel-的用户需要注意的事项)CentOS/RHEL 的用户需要注意的事项
...
← [Docker 列出镜像](https://funtl.com/zh/docs-docker/Docker-列出镜像.html)[利用 commit 理解镜像构成 ](https://funtl.com/zh/docs-docker/Docker-利用-commit-理解镜像构成.html)→