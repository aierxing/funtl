# [#](https://funtl.com/zh/docs-docker/Swarm-mode-创建-Swarm-集群.html#创建-swarm-集群)创建 Swarm 集群

阅读 `基本概念` 一节我们知道 `Swarm` 集群由 **管理节点** 和 **工作节点** 组成。本节我们来创建一个包含一个管理节点和两个工作节点的最小 `Swarm` 集群。

## [#](https://funtl.com/zh/docs-docker/Swarm-mode-创建-Swarm-集群.html#初始化集群)初始化集群
...
## [#](https://funtl.com/zh/docs-docker/Swarm-mode-创建-Swarm-集群.html#增加工作节点)增加工作节点
...
## [#](https://funtl.com/zh/docs-docker/Swarm-mode-创建-Swarm-集群.html#查看集群)查看集群
...
← [Swarm mode 基本概念](https://funtl.com/zh/docs-docker/Swarm-mode-基本概念.html)[Swarm mode 部署服务 ](https://funtl.com/zh/docs-docker/Swarm-mode-部署服务.html)→