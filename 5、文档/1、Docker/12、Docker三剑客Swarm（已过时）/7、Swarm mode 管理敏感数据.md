# [#](https://funtl.com/zh/docs-docker/Swarm-mode-管理敏感数据.html#swarm-mode-管理敏感数据)Swarm mode 管理敏感数据
...
## [#](https://funtl.com/zh/docs-docker/Swarm-mode-管理敏感数据.html#创建-secret)创建 secret
...
## [#](https://funtl.com/zh/docs-docker/Swarm-mode-管理敏感数据.html#查看-secret)查看 secret
...
## [#](https://funtl.com/zh/docs-docker/Swarm-mode-管理敏感数据.html#创建-mysql-服务)创建 MySQL 服务
...
← [使用 compose 文件](https://funtl.com/zh/docs-docker/Swarm-mode-使用-compose-文件.html)[Swarm mode 管理配置信息 ](https://funtl.com/zh/docs-docker/Swarm-mode-管理配置信息.html)→