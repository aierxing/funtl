# [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#实现数据持久化)实现数据持久化

## [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#本节视频)本节视频

[【（千锋教育）服务网格化 Service Mesh】Kubernetes-实现数据持久化](https://www.bilibili.com/video/av52359802/?p=18)

## [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#概述)概述
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#pv-与-pvc)PV 与 PVC
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#定义-pv)定义 PV

### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#持久卷插件)持久卷插件
...
### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#yaml-配置)YAML 配置
...
### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#配置说明)配置说明

#### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#capacity（容量）)Capacity（容量）

一般来说，PV 会指定存储容量。这里需要使用 PV 的 capcity 属性。目前存储大小是唯一一个能够被申请的指标，今后会加入更多属性，例如 IOPS，吞吐能力等。

#### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#accessmodes（访问模式）)AccessModes（访问模式）
...
#### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#recyclingpolicy（回收策略）)RecyclingPolicy（回收策略）
...
#### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#阶段（phase）)阶段（Phase）
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#定义-pvc)定义 PVC
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#部署-mysql8)部署 MySQL8
...
### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#解决权限问题)解决权限问题
...
### [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#测试运行)测试运行

部署成功后可以使用 `kubectl get service` 查看我们 MySQL 的运行端口，再使用连接工具连接会报如下错误

![img](https://funtl.com/assets1/Lusifer_20190609212326.png)

意思为无法使用密码的方式登录，在 Docker 部署时我们可以在 YAML 中配置相关参数解决这个问题；下一节我们讲解在 Kubernetes 中采用 **ConfigMap** 的方式配置 MySQL

## [#](https://funtl.com/zh/service-mesh-kubernetes/实现数据持久化.html#附：imagepullpolicy)附：ImagePullPolicy
...
← [准备数据持久化](https://funtl.com/zh/service-mesh-kubernetes/准备数据持久化.html)[Kubernetes ConfigMap ](https://funtl.com/zh/service-mesh-kubernetes/ConfigMap.html)→