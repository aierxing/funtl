# [#](https://funtl.com/zh/service-mesh-kubernetes/使用-kubeadm.html#使用-kubeadm-搭建-kubernetes-集群)使用 kubeadm 搭建 kubernetes 集群

## [#](https://funtl.com/zh/service-mesh-kubernetes/使用-kubeadm.html#本节视频)本节视频

[【（千锋教育）服务网格化 Service Mesh】Kubernetes-使用 kubeadm](https://www.bilibili.com/video/av52359802/?p=6)

## [#](https://funtl.com/zh/service-mesh-kubernetes/使用-kubeadm.html#安装-kubernetes-主节点)安装 kubernetes 主节点
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/使用-kubeadm.html#配置-kubectl)配置 kubectl
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/使用-kubeadm.html#验证是否成功)验证是否成功
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/使用-kubeadm.html#kubeadm-init-的执行过程)kubeadm init 的执行过程
...
← [配置 kubeadm](https://funtl.com/zh/service-mesh-kubernetes/配置-kubeadm.html)[使用 kubeadm 配置 slave 节点 ](https://funtl.com/zh/service-mesh-kubernetes/配置-Slave.html)→