# [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#配置网络)配置网络

## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#本节视频)本节视频
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#概述)概述
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#什么是-cni)什么是 CNI

CNI(Container Network Interface) 是一个标准的，通用的接口。在容器平台，Docker，Kubernetes，Mesos 容器网络解决方案 flannel，calico，weave。只要提供一个标准的接口，就能为同样满足该协议的所有容器平台提供网络功能，而 CNI 正是这样的一个标准接口协议。

## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#kubernetes-中的-cni-插件)Kubernetes 中的 CNI 插件
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#什么是-calico)什么是 Calico

Calico 为容器和虚拟机提供了安全的网络连接解决方案，并经过了大规模生产验证（在公有云和跨数千个集群节点中），可与 Kubernetes，OpenShift，Docker，Mesos，DC / OS 和 OpenStack 集成。

Calico 还提供网络安全规则的动态实施。使用 Calico 的简单策略语言，您可以实现对容器，虚拟机工作负载和裸机主机端点之间通信的细粒度控制。

## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#安装网络插件-calico)安装网络插件 Calico
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#解决-imagepullbackoff)解决 ImagePullBackOff
...
## [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#附：配置固定-ip-和-dns)附：配置固定 IP 和 DNS
...
### [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#修改固定-ip)修改固定 IP
...
### [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#修改-dns)修改 DNS

#### [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#方法一)方法一
...
#### [#](https://funtl.com/zh/service-mesh-kubernetes/配置网络.html#方法二)方法二
...
![img](https://funtl.com/assets1/Lusifer_20190602201826.png)

上次更新: 2019-9-26 18:10:22

← [使用 kubeadm 配置 slave 节点](https://funtl.com/zh/service-mesh-kubernetes/配置-Slave.html)[第一个 Kubernetes 容器 ](https://funtl.com/zh/service-mesh-kubernetes/第一个-Kubernetes-容器.html)→