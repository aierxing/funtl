# [#](https://funtl.com/zh/spring-cloud-alibaba-dubbo-vue/创建项目工程.html#创建项目工程)创建项目工程

## [#](https://funtl.com/zh/spring-cloud-alibaba-dubbo-vue/创建项目工程.html#pom)POM
...
← [基于 Docker 安装 Nacos](https://funtl.com/zh/spring-cloud-alibaba-dubbo-vue/基于-Docker-安装-Nacos.html)[创建统一的依赖管理 ](https://funtl.com/zh/spring-cloud-alibaba-dubbo-vue/创建统一的依赖管理.html)→