...
## [#](https://funtl.com/zh/vuex/#简介)简介

Vuex 是一个专为 Vue.js 应用程序开发的 **状态管理模式**。它采用集中式存储管理应用的所有组件的状态，并以相应的规则保证状态以一种可预测的方式发生变化。

## [#](https://funtl.com/zh/vuex/#目标)目标

继续之前 [vue-router](https://funtl.com/zh/vue-router/) 章节做的案例项目，我们通过完善登录功能将用户信息保存至 Vuex 中来体会它的作用；

## [#](https://funtl.com/zh/vuex/#安装)安装
...
## [#](https://funtl.com/zh/vuex/#判断用户是否登录)判断用户是否登录

我们利用路由钩子 `beforeEach` 来判断用户是否登录，期间会用到 `sessionStorage` 存储功能

### [#](https://funtl.com/zh/vuex/#修改-login-vue)修改 `Login.vue`
...
### [#](https://funtl.com/zh/vuex/#修改-main-js)修改 `main.js`
...
## [#](https://funtl.com/zh/vuex/#配置-vuex)配置 `vuex`

### [#](https://funtl.com/zh/vuex/#创建-vuex-配置文件)创建 Vuex 配置文件
...
### [#](https://funtl.com/zh/vuex/#解决浏览器刷新后-vuex-数据消失问题)解决浏览器刷新后 Vuex 数据消失问题

#### [#](https://funtl.com/zh/vuex/#问题描述)问题描述
...
#### [#](https://funtl.com/zh/vuex/#解决方案)解决方案
...
#### [#](https://funtl.com/zh/vuex/#修改代码)修改代码
...
## [#](https://funtl.com/zh/vuex/#模块化)模块化

由于使用单一状态树，应用的所有状态会集中到一个比较大的对象。当应用变得非常复杂时，store 对象就有可能变得相当臃肿。为了解决以上问题，Vuex 允许我们将 store 分割成模块（module）。每个模块拥有自己的 state、mutation、action、getter、甚至是嵌套子模块——从上至下进行同样方式的分割

### [#](https://funtl.com/zh/vuex/#创建-user-模块)创建 `user` 模块
...
### [#](https://funtl.com/zh/vuex/#修改-store-index-js)修改 `store/index.js`
...
### [#](https://funtl.com/zh/vuex/#修改-app-vue)修改 `App.vue`
