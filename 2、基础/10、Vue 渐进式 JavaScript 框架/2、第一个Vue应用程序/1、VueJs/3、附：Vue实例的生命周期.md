# [#](https://funtl.com/zh/vue/附：Vue-实例的生命周期.html#附：vue-实例的生命周期)附：Vue 实例的生命周期

## [#](https://funtl.com/zh/vue/附：Vue-实例的生命周期.html#什么是生命周期)什么是生命周期

Vue 实例有一个完整的生命周期，也就是从开始创建、初始化数据、编译模板、挂载 DOM、渲染→更新→渲染、卸载等一系列过程，我们称这是 Vue 的生命周期。通俗说就是 Vue 实例从创建到销毁的过程，就是生命周期。

在 Vue 的整个生命周期中，它提供了一系列的事件，可以让我们在事件触发时注册 JS 方法，可以让我们用自己注册的 JS 方法控制整个大局，在这些事件响应方法中的 this 直接指向的是 Vue 的实例。

![img](https://funtl.com/assets1/6aedb651gy1fmncxvp4doj20xc2cfaim.jpg)

> 特别值得注意的是 `created` 钩子函数和 `mounted` 钩子函数的区别

## [#](https://funtl.com/zh/vue/附：Vue-实例的生命周期.html#钩子函数的触发时机)钩子函数的触发时机
...
← [第一个 Vue 应用程序](https://funtl.com/zh/vue/第一个-Vue-应用程序.html)[v-if,v-else ](https://funtl.com/zh/vue/v-if-v-else.html)→