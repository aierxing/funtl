# [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#浏览器端存储技术简介)浏览器端存储技术简介

## [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#本节视频)本节视频

- [【视频】课后作业-记住我](https://www.bilibili.com/video/av24698335/)

## [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#cookie)Cookie
...
## [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#localstorage)LocalStorage
...
## [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#sessionstorage)SessionStorage

SessionStorage 与 LocalStorage 的唯一一点区别就是 LocalStorage 属于永久性存储，而 SessionStorage 属于当会话结束的时候，SessionStorage 中的键值对就会被清空。

## [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#userdata、globalstorage、google-gear)UserData、GlobalStorage、Google Gear
...
## [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#flash-shareobject（flash-cookie）)Flash ShareObject（Flash Cookie）

这种方式能能解决上面提到的 Cookie 存储的两个弊端，而且能够跨浏览器，应该说是目前最好的本地存储方案。不过，需要在页面中插入一个 Flash，当浏览器没有安装 Flash 控件时就不能用了。所幸的是，没有安装 Flash 的用户极少。

## [#](https://funtl.com/zh/spring-web/浏览器端存储技术简介.html#附：cookieutils)附：CookieUtils
