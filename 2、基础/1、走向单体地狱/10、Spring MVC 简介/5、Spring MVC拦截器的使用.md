# [#](https://funtl.com/zh/spring-mvc/Spring-MVC-拦截器的使用.html#spring-mvc-拦截器的使用)Spring MVC 拦截器的使用

## [#](https://funtl.com/zh/spring-mvc/Spring-MVC-拦截器的使用.html#本节视频)本节视频

- [【视频】Spring MVC 与 Maven 模块化开发-Spring MVC 拦截器的使用](https://www.bilibili.com/video/av24742046/)

## [#](https://funtl.com/zh/spring-mvc/Spring-MVC-拦截器的使用.html#拦截器简介)拦截器简介

Spring Web MVC 的处理器拦截器，类似于 Servlet 开发中的过滤器 Filter，用于对处理器进行预处理和后处理。

## [#](https://funtl.com/zh/spring-mvc/Spring-MVC-拦截器的使用.html#常见应用场景)常见应用场景
...
## [#](https://funtl.com/zh/spring-mvc/Spring-MVC-拦截器的使用.html#第一个-spring-mvc-拦截器)第一个 Spring MVC 拦截器
...
### [#](https://funtl.com/zh/spring-mvc/Spring-MVC-拦截器的使用.html#创建登录拦截器)创建登录拦截器
...
### [#](https://funtl.com/zh/spring-mvc/Spring-MVC-拦截器的使用.html#在-spring-mvc-xml-中配置拦截器)在 `spring-mvc.xml` 中配置拦截器
