# [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#maven-模块化开发)Maven 模块化开发

## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#本节视频)本节视频

- [【视频】Spring MVC 与 Maven 模块化开发-Maven 模块化开发](https://www.bilibili.com/video/av24742070/)

## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#概述)概述
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#创建根项目（工程）)创建根项目（工程）
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#创建统一的依赖管理)创建统一的依赖管理
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#创建通用的工具类)创建通用的工具类
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#创建领域模型)创建领域模型
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#创建管理后台)创建管理后台
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#创建商城前端)创建商城前端
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#创建接口模块)创建接口模块
...
## [#](https://funtl.com/zh/spring-mvc/Maven-模块化开发.html#清理、编译、打包)清理、编译、打包
