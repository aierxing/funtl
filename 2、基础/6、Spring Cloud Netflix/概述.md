...
## [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#视频合辑)视频合辑

- [【千锋教育】微服务架构之 Spring Cloud Netflix](https://www.bilibili.com/video/av29384041)

## [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#概述)概述
...
## [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#项目已经进入维护模式)项目已经进入维护模式
...
### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#什么是维护模式)什么是维护模式

将模块置于维护模式，意味着 Spring Cloud 团队将不会再向模块添加新功能。我们将修复 block 级别的 bug 以及安全问题，我们也会考虑并审查社区的小型 pull request。

### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#替代品)替代品
...
### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#其它补充)其它补充

#### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#netflix-concurrency-limits)Netflix Concurrency Limits

并发限制模块，它是 Netflix 开源的限流器项目，Spring Cloud 在 Greenwich 版本中引入 spring-cloud-netflix-concurrency-limits

#### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#archaius-1)Archaius 1
...
#### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#resilience4j)Resilience4j

目前还中孵化中，Spring 可能是要抽象一个断路器的统一规范，让不同的断路器（Hystrix、Resilience4j、**Sentinel（阿里开源）**）选择使用

#### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#micrometer)Micrometer
...
#### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#spring-cloud-loadbalancer)Spring Cloud Loadbalancer

目前还中孵化中，使用上和 Ribbon 区别不大

#### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#spring-cloud-gateway)Spring Cloud Gateway
...
#### [#](https://funtl.com/zh/guide/Spring-Cloud-Netflix.html#spring-boot-external-config-spring-cloud-config)Spring Boot external config + Spring Cloud Config
...
← [Spring Boot](https://funtl.com/zh/guide/Spring-Boot.html)[Spring Cloud iToken ](https://funtl.com/zh/guide/Spring-Cloud-iToken.html)→