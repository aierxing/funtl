# [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#配置-swagger2-接口文档引擎)配置 Swagger2 接口文档引擎

## [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#本节视频)本节视频

- [【视频】Spring Cloud Alibaba-MyShop-Swagger2 接口文档引擎](https://www.bilibili.com/video/av43402234/)

## [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#手写文档存在的问题)手写文档存在的问题
...
## [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#使用-swagger-解决问题)使用 Swagger 解决问题

Swagger 也就是为了解决这个问题，当然也不能说 Swagger 就一定是完美的，当然也有缺点，最明显的就是代码植入性比较强。

### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#maven)Maven
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#配置-swagger2)配置 Swagger2
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#启用-swagger2)启用 Swagger2
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#使用-swagger2)使用 Swagger2
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#访问-swagger2)访问 Swagger2

访问地址：http://ip:port/swagger-ui.html

![img](https://funtl.com/assets1/Lusifer_20190213003615.png)

## [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#swagger-常用注解说明)Swagger 常用注解说明

Swagger 通过注解表明该接口会生成文档，包括接口名、请求方法、参数、返回信息的等等。

### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#常用注解)常用注解
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#api)`@Api`
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#apioperation)`@ApiOperation`
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#apiimplicitparams)`@ApiImplicitParams`
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#apimodel)`@ApiModel`
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#apiresponses)`@ApiResponses`
...
### [#](https://funtl.com/zh/spring-cloud-alibaba-myshop/配置-Swagger2-接口文档引擎.html#apiparam)`@ApiParam`
...
上次更新: 2019-2-14 2:34:58

← [发送注册成功邮件](https://funtl.com/zh/spring-cloud-alibaba-myshop/发送注册成功邮件.html)[创建商品服务提供者 ](https://funtl.com/zh/spring-cloud-alibaba-myshop/创建商品服务提供者.html)→