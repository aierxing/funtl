# [#](https://funtl.com/zh/spring-cloud-alibaba/创建统一的依赖管理.html#创建统一的依赖管理)创建统一的依赖管理

## [#](https://funtl.com/zh/spring-cloud-alibaba/创建统一的依赖管理.html#本节视频)本节视频

- [Spring Cloud Alibaba-创建统一的依赖管理](https://www.bilibili.com/video/av40469026/)

## [#](https://funtl.com/zh/spring-cloud-alibaba/创建统一的依赖管理.html#概述)概述
...
## [#](https://funtl.com/zh/spring-cloud-alibaba/创建统一的依赖管理.html#创建依赖管理项目)创建依赖管理项目
...
## [#](https://funtl.com/zh/spring-cloud-alibaba/创建统一的依赖管理.html#依赖版本说明)依赖版本说明
...
## [#](https://funtl.com/zh/spring-cloud-alibaba/创建统一的依赖管理.html#与-spring-cloud-netflix-的区别)与 Spring Cloud Netflix 的区别

主要增加了 `org.springframework.cloud:spring-cloud-alibaba-dependencies`

![img](https://funtl.com/assets1/Lusifer_20190113133947.png)

上次更新: 2019-1-14 4:44:31

← [简介](https://funtl.com/zh/spring-cloud-alibaba/)[服务注册与发现 ](https://funtl.com/zh/spring-cloud-alibaba/服务注册与发现.html)→