...
## [#](https://funtl.com/zh/spring-cloud-alibaba/#本节视频)本节视频
...
## [#](https://funtl.com/zh/spring-cloud-alibaba/#视频合辑)视频合辑

- [【千锋教育】微服务架构之 Spring Cloud Alibaba](https://www.bilibili.com/video/av40924228/)

## [#](https://funtl.com/zh/spring-cloud-alibaba/#概述)概述
...
**注：学习 Spring Cloud Alibaba 之前，先学习一下我之前的 [Spring Cloud](https://funtl.com/zh/spring-cloud-netflix/#简介) 课程，效果更佳哦；**

[Spring Cloud Alibaba GitHub](https://github.com/spring-cloud-incubator/spring-cloud-alibaba/blob/master/README-zh.md)

## [#](https://funtl.com/zh/spring-cloud-alibaba/#主要功能)主要功能
...
## [#](https://funtl.com/zh/spring-cloud-alibaba/#组件)组件
...
[创建统一的依赖管理 ](https://funtl.com/zh/spring-cloud-alibaba/创建统一的依赖管理.html)→