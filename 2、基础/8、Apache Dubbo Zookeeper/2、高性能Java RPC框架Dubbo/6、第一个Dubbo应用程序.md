# [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#第一个-dubbo-应用程序)第一个 Dubbo 应用程序

## [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#本节视频)本节视频
...
## [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#概述)概述

![img](https://funtl.com/assets/687474703a2f2f647562626f2e6170616368652e6f72672f696d672f6172636869746563747572652e706e67.png)

## [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#创建服务接口项目)创建服务接口项目

创建一个名为 `hello-dubbo-service-user-api` 的项目，该项目只负责**定义接口**

### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#pom)POM
...
### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#定义服务接口)定义服务接口
...
## [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#创建服务提供者项目)创建服务提供者项目

创建一个名为 `hello-dubbo-service-user-provider` 的项目，该项目主要用于实现接口

### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#pom-2)POM
...
### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#通过-service-注解实现服务提供方)通过 `@Service` 注解实现服务提供方
...
### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#application)Application
...
### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#application-yml)application.yml
...
## [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#创建服务消费者项目)创建服务消费者项目

创建一个名为 `hello-dubbo-service-user-consumer` 的项目，该项目用于消费接口（调用接口）

### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#pom-3)POM
...
### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#通过-reference-注入-userservice)通过 `@Reference` 注入 `UserService`
...
### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#application-2)Application
...
### [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#application-yml-2)application.yml
...
## [#](https://funtl.com/zh/apache-dubbo-rpc/第一个-Dubbo-应用程序.html#启动-dubbo-admin-控制台)启动 Dubbo Admin 控制台

查看是否成功注册服务，效果图如下：

![img](https://funtl.com/assets/Lusifer_20181022010246.png)

上次更新: 2019-4-19 19:23:15

← [Dubbo Admin 管理控制台](https://funtl.com/zh/apache-dubbo-rpc/Dubbo-Admin-管理控制台.html)[Dubbo 的负载均衡 ](https://funtl.com/zh/apache-dubbo-rpc/Dubbo-的负载均衡.html)→