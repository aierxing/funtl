# [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#quartz-使用)Quartz 使用

## [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#本节视频)本节视频

- [【视频】项目实战-iToken-任务调度-Quartz](https://www.bilibili.com/video/av29891329)

## [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#概述)概述
...
## [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#为什么使用-quartz？)为什么使用 Quartz？
...
## [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#什么是-cron-表达式？)什么是 cron 表达式？

cron 是 Linux 系统用来设置计划任务的，比如：每天晚上 12 点重启服务器。

### [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#格式)格式
...
## [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#spring-boot-集成-quartz)Spring Boot 集成 Quartz

### [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#创建项目)创建项目

创建一个名为 `hello-quartz` 的项目

### [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#pom)POM
...
### [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#application)Application
...
### [#](https://funtl.com/zh/spring-cloud-itoken-codeing/Quartz-使用.html#创建任务)创建任务
...
![img](https://funtl.com/assets/Lusifer1534681836.png)

上次更新: 2019-4-19 19:23:15

← [RabbitMQ 使用](https://funtl.com/zh/spring-cloud-itoken-codeing/RabbitMQ-使用.html)