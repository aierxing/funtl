# [#](https://funtl.com/zh/docker/Docker-列出镜像.html#列出镜像)列出镜像

## [#](https://funtl.com/zh/docker/Docker-列出镜像.html#本节视频)本节视频

- [【视频】基础设施即服务-Docker-镜像-列出镜像](https://www.bilibili.com/video/av27289204)

## [#](https://funtl.com/zh/docker/Docker-列出镜像.html#概述)概述
...
## [#](https://funtl.com/zh/docker/Docker-列出镜像.html#镜像体积)镜像体积
...
## [#](https://funtl.com/zh/docker/Docker-列出镜像.html#虚悬镜像)虚悬镜像
...
## [#](https://funtl.com/zh/docker/Docker-列出镜像.html#中间层镜像)中间层镜像
...
## [#](https://funtl.com/zh/docker/Docker-列出镜像.html#列出部分镜像)列出部分镜像
...
## [#](https://funtl.com/zh/docker/Docker-列出镜像.html#以特定格式显示)以特定格式显示
...
← [获取镜像](https://funtl.com/zh/docker/Docker-获取镜像.html)[删除本地镜像 ](https://funtl.com/zh/docker/Docker-删除本地镜像.html)→